            ...
            public void run() {
                try {
                    ...
                    while (true) {
                        ...
                        mod.addElement(data);
                        txt.append("The 1 file was found... \n");
                    }
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(Server.this, e, "The request file cannot be found on the peer overlay", JOptionPane.ERROR_MESSAGE);
                }
    ...
    private void save() {
        ...
        if (c == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(this, e, "The request file cannot be found on the peer overlay", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
